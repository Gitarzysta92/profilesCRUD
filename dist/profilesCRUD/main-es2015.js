...
let AddProfileComponent = class AddProfileComponent {
    ...
    getCurrentDate() {
        const pipe = new _angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"]('en-GB');
...
let EditProfileComponent = class EditProfileComponent {
    constructor(route, profileService, location) {
        this.route = route;
        this.profileService = profileService;
        this.location = location;
        this.formSetup = {
    ...
    getCurrentDate() {
        const pipe = new _angular_common__WEBPACK_IMPORTED_MODULE_3__["DatePipe"]('en-GB');
        const currentDateTime = Date.now();
        return pipe.transform(currentDateTime, 'short');
    }
    getUserData() {
...
let ProfileService = class ProfileService {
    ...
    getProfiles() {
        return this.http.get(this.profilesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(_ => this.log('Profiles fetched', 'ok')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getProfiles', [])));
    }
    getProfile(id) {
        return this.http.get(`${this.profilesUrl}/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(() => this.log('Profile fetched', 'ok')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getProfile')));
    }
    addProfile(profile) {
        return this.http.post(`${this.profilesUrl}`, profile)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(() => this.log('Profile added', 'ok')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('addProfile')));
    }
    updateProfile(profile) {
        return this.http.put(`${this.profilesUrl}`, profile)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(() => this.log('Profile update', 'ok')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('updateProfile')));
    }
    deleteProfile(id) {
        console.log(id);
        return this.http.delete(`${this.profilesUrl}/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(() => this.log('Profile removed', 'ok')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('removeProfile')));
    }
